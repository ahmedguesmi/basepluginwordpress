...
class EnqueueScripts extends Plugin {
  ...
  public function enqueue_frontend_scripts() {
    ...
    wp_enqueue_style( 'basepluginwordpress', Helpers::get_script_url( 'assets/css/basepluginwordpress.css' ), null, Helpers::get_script_version( 'assets/css/basepluginwordpress.css' ) );

    // Enqueue frontend JavaScript
    wp_enqueue_script( 'basepluginwordpress', Helpers::get_script_url( 'assets/js/basepluginwordpress.js' ), array( 'jquery', 'jquery-waituntilexists' ), Helpers::get_script_version( 'assets/js/basepluginwordpress.js' ), true );
    wp_localize_script( 'basepluginwordpress', $this->prefix( 'ajax_filter_params' ), array( 'ajax_url' => admin_url( 'admin-ajax.php' ) ) );
  ...
  public function enqueue_admin_scripts() {
    ...
    // Enqueuing custom CSS for child theme (Twentysixteen was used for testing)
    wp_enqueue_style( 'basepluginwordpress', Helpers::get_script_url( 'assets/css/basepluginwordpress-admin.css' ), null, Helpers::get_script_version( 'assets/css/basepluginwordpress-admin.css' ) );

    // Enqueue WP Admin JavaScript
    wp_enqueue_script( 'basepluginwordpress-admin', Helpers::get_script_url( 'assets/js/basepluginwordpress-admin.js' ), array('jquery', 'jquery-waituntilexists'), Helpers::get_script_version( 'assets/js/basepluginwordpress-admin.js' ), true );
    wp_localize_script( 'basepluginwordpress-admin', $this->prefix( 'ajax_filter_params' ), array( 'ajax_url' => admin_url( 'admin-ajax.php' ) ) );
